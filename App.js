...
{
fetch('http://localhost/guia9/basedatos/apiusuario.php?comando=autenticar& usuario='+this.state.usuario+'&contrasena='+this.state.contrasena, {
method: 'GET'
})
...
{
console.log('Prueba');
fetch('http://localhost/guia9/basedatos/api.php?comando=listar', {
method: 'GET'
})
.then((response) => response.json())
.then((responseJson) => {
...
Actualizar()
{
fetch('http://localhost/guia9/basedatos/api.php?comando=editar&nombre='+this.state.nombre
...
Eliminar()
{
fetch('http://localhost/guia9/basedatos/api.php?comando=eliminar&id='+this
.state.id, {
method: 'GET'
})
.then((response) => response.json())
...
Guardar()
{
fetch('http://localhost/guia9/basedatos/api.php?comando=agregar&nombre='+this.state.nombre
+'&descripcion='+this.state.descripcion
+'&cantidad='+this.state.cantidad
+'&preciodecosto='+this.state.preciodecosto
+'&preciodeventa='+this.state.preciodeventa
